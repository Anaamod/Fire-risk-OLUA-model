...
fully_anticipated = luc_model(;damage_rate=damage_rate, tdamage=tdamage, standard_options...) # compute the optimization for the scenario without damage
...
plot(times,base.welfare[ix],title="Welfare",label="base",xlims=(0,100),linewidth=2,legend=false,xlabel="time",ylabel="welfare");
plot!(times,fully_anticipated.welfare[ix], label="fully anticipated",linewidth=2,linestyle=:dash);
plot!(times,merged.welfare[ix], label="ex-post adapt",linewidth=2,linestyle=:dashdot)
savefig("welfare")
...
# Some plots...
plot(times,base.V[ix], title="Volumes", label="base",xlims=(0,100),linewidth=2, xlabel="time", ylabel="V",legend=false);
plot!(times,fully_anticipated.V[ix], label="fully anticipated",linewidth=2, linestyle=:dash);
plot!(times,merged.V[ix], label="ex-post adapt",linewidth=2,linestyle=:dashdot)
savefig("carb_storage.png")


plot(times,base.ben_agr[ix], title="Benefit from other land",label="base",xlims=(0,100))
plot!(times,fully_anticipated.ben_agr[ix], label="fully anticipated")
plot!(times,merged.ben_agr[ix], label="ex-post adapt")

plot(times,base.ben_env2[ix], title="Benefit from carbon sequestration",label="base",xlims=(0,100))
plot!(times,fully_anticipated.ben_env2[ix], label="fully anticipated")
plot!(times,merged.ben_env2[ix], label="ex-post adapt")

plot(times,base.h[ix], title="harvest rates",label="base",xlims=(0,100),linewidth=2, xlabel="time", ylabel="h",legend=false)
plot!(times,fully_anticipated.h[ix], label="fully anticipated",linewidth=2, linestyle=:dash)
plot!(times,merged.h[ix], label="ex-post adapt",linewidth=2, linestyle=:dashdot)
savefig("h")



plot(times,base.co2_seq[ix], title= "Carbon storage",label="base",xlims=(0,100),linewidth=2,xlabel="time", ylabel="κ*Vt",legend=false)
plot!(times,fully_anticipated.co2_seq[ix], label="fully anticipated",linewidth=2, linestyle=:dash)
plot!(times,merged.co2_seq[ix], label="ex-post adapt",linewidth=2, linestyle=:dashdot)
savefig("carb_storage")


plot(times,base.ben_env2[ix], title= "carbon benefits for a 90% damage rate",label="base", xlims=(0,100),legend=false,xlabel="time",linewidth=2)
plot!(times,fully_anticipated.ben_env2[ix], label="fully anticipated",linewidth=2,linestyle=:dash)
plot!(times,merged.ben_env2[ix], label="ex-post adapt",linewidth=2, linestyle=:dashdot)
savefig("carb90")


plot(times,base.ben_wood[ix], title= "timber benefits for a 90% damage rate",label="base", xlims=(0,100),legend=false,xlabel="time",linewidth=2)
plot!(times,fully_anticipated.ben_wood[ix], label="fully anticipated",linewidth=2,linestyle=:dash)
plot!(times,merged.ben_wood[ix], label="ex-post adapt",linewidth=2, linestyle=:dashdot)
savefig("h90")
...
plot(times, (-(base.r_A[ix] .+ base.r_F[ix])), label = "base", linewidth=2,xlims=(0,100),legend=false, xlabel=time, ylabel="rt", title="From forest to other land")
plot!(times, (-(fully_anticipated.r_A[ix] .+ fully_anticipated.r_F[ix])), label="fully anticipated",linewidth=2, linestyle=:dash)
plot!(times, (-(merged.r_A[ix] .+ merged.r_F[ix])), label="ex-post adapt",linewidth=2, linestyle=:dashdot)
savefig("rt")


plot(times, (base.r_A[ix] .+ base.r_F[ix]), label = "base", linewidth=2,xlims=(0,100),legend=false, xlabel=time, ylabel="r_t", title="land coversion from other land to forest")
plot!(times, (fully_anticipated.r_A[ix] .+ fully_anticipated.r_F[ix]), label="fully anticipated",linewidth=2, linestyle=:dash)
plot!(times, (merged.r_A[ix] .+ merged.r_F[ix]), label="ex-post adapt",linewidth=2, linestyle=:dashdot)
savefig("rt")


plot(times,(base.a[ix]), title= "Forest to other land",label="base",xlims=(0,100),ylims=(-0.0000001,0.0000001),legend=false,linewidth=2,xlabel="time", ylabel=L"|\;r_t\;|");
plot!(times,(fully_anticipated.a[ix]), label="fully anticipated",linewidth=2, linestyle=:dash);
plot!(times,(merged.a[ix]), label="ex-post adapt",linewidth=2, linestyle=:dashdot)
savefig("otherland")
