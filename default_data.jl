...
"""
Multiplier of the environmental benefits for primary forests
...
"""
benv_c1    = 0.0 * F₀ /(F₀^(benv_c2))

# -----------------


benv2_c2    = 1/2 # Power of the environmental benefit
"""
Multiplier of the environmental benefits for secondary forests

benv2_c1 is calibrated such that:
ben_env = (0.3*2700) * F₀
That is, the environmental benefits is equal to the €/hectar value from literature multiplied the initial area (in Mha),
Hence it is such that ben_env is in M\$
"""
benv2_c1    = 0.25* V₀ /(V₀^(benv2_c2))
...
"""
bwood_c1   = 90 * (d₀*D + h₀*V₀/S₀) / ((d₀*D + h₀*V₀/S₀)^bwood_c2 ) # Multiplier of the wood-use benefits
# --------
...
# --------
chsf_c2    = 2   # Power of the harvesting costs of secondary forest
"""
...
"""
chsf_c1    = 25 * (h₀*V₀/S₀) / ((h₀*V₀/S₀)^chsf_c2)   # Multiplier of the harvesting costs of secondary forest
# --------
crsf_c2    = 2   # Power of the regeneration costs of secondary forest
"""
...
"""
crsf_c1    = 150 * (r_F₀+r_A₀+h₀) / ((r_F₀+r_A₀+h₀)^crsf_c2) # Multiplier of the regeneration costs of secondary forest
