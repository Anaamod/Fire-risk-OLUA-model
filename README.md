...
ben_env2(V;benv2_c1,benv2_c2)                    = (benv2_c1*V^benv2_c2) # Environmental benefits [M$]
...
function welfare(F,S,A,V,d,h,r_F,r_A,t;D,γ,K,
  ...
  + ben_env2(V;benv2_c1=benv2_c1,benv2_c2=benv2_c2)  
...
function luc_model(;
  ...
  benv2_c1    = benv2_c1, # Multiplier of the environmental benefits for secondary forests
  benv2_c2    = benv2_c2, # Power of the environmantal benefit for secondary forests
  ...
  @objective(m, Max, integral(
    welfare(F,S,A,V,d,h,r_F,r_A,t;
            ...
            benv2_c1=benv2_c1,benv2_c2=benv2_c2,
  ...
  ben_env2_opt = ben_env2.(V_opt;benv2_c1=benv2_c1,benv2_c2=benv2_c2)
  ...
  return (F=F_opt, S=S_opt, A=A_opt, V=V_opt, d=d_opt, h=h_opt, r_F=r_Fopt,r_A=r_Aopt,a=aopt,
          ...
          ben_env = ben_env_opt, ben_env2 = ben_env2_opt, ben_agr = ben_agr_opt, ben_wood= ben_wood_opt, ben_carbon_seq = ben_carbon_seq_opt, ben_carbon_sub = ben_carbon_sub_opt,
